...
sap.ui.define(
	function() {
		...
		opaTest("Exiting RTA", function(Give, When, Then) {
			...
			Then.onTheMasterPageWithRTA.iShouldSeeTheFLPToolbarAndChangesInLRep(7);
		});
		...
		opaTest("Reloading the App", function(Given, When, Then) {
			...
			Then.onTheMasterPageWithRTA.iShouldSeeChangesInLRepWhenTheBusyIndicatorIsGone("idAppControl", "Root", 7).
